...
{
    public static Elevator1 thisC1;
    public List<ElevatorPort1> listElevatorPortC { get; set; }
    ...
    {
        thisC1 = this;
        listElevatorPortC = new List<ElevatorPort1>();
        foreach (Transform loopTra in this.transform.Find("ElevatorPorts"))
        {
            listElevatorPortC.Add(loopTra.GetComponent<ElevatorPort1>());
        }
    ...
    private void Update()
    {
        if (isWait)
        {
            ElevatorPort1 tempElevatorPortC = listElevatorPortC[targetLayerIndex];
    ...
    private bool CheckAllDoor()
    {
        ...
        if (returnIsClose)
        {
            foreach (ElevatorPort1 loopElevatorPortC in listElevatorPortC)
            {
